		...
		<div className='min-h-screen flex items-center justify-center px-4'>
			...
			>
				<div className='p-6 sm:p-8'>
					...
					<h1 className='text-2xl sm:text-3xl font-bold text-center text-green-500 mb-2'>Satın Alım İşlemi Tamamlandı</h1>
					<p className='text-gray-300 text-center mb-6'>
                        Siparişiniz için teşekkür ederiz. Şu anda işleme alıyoruz.
					</p>
					<div className='bg-gray-700 rounded-lg p-4 mb-6'>
                        <p className='text-sm text-gray-400 text-center'>
                            Sipariş ayrıntıları ve güncellemeler için{" "}
                            <Link to="/siparislerim" className="text-emerald-400 hover:underline">
                                siparişlerim 
                            </Link>{" "}
